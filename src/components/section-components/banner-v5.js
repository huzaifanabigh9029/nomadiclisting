					...
					<div className="container">
						...
						<div className="col-lg-12 align-self-center">
							...
							<div className="ltn__car-dealer-form-tab">
								...
								<div className="nav">
									<a className="active show" data-bs-toggle="tab" href="#ltn__form_tab_1_1"><i className="fas fa-car" />Auto Mobile</a>
									<a data-bs-toggle="tab" href="#ltn__form_tab_1_2" className><i className="fas fa-home" />Property</a>
								</div>
								</div>
