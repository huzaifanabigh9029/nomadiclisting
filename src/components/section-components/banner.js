...
function Banner() {
  const [rotate, setRotate] = useState("slide-item-img");
              ...
              <div className="row">
                <div className="col-lg-12 align-self-center">
                  ...
                  <div
                    className={
                      "slide-item-img " +
                      (dir === "rtl" ? "slide-img-left" : "slide-item-img")
                    }
                  >
                    <img
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-12 align-self-center">
                  ...
                  <div
                    className={
                      " slide-item-img slide-img-left " +
                      (dir === "rtl" ? " " : "slide-item-img")
                    }
                  >
                    <img
                      src={publicUrl + "/assets/img/slider/21.png"}
